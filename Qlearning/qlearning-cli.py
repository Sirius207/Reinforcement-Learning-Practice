# source: https://www.youtube.com/watch?v=OkGFJE_XDzI&list=PLXO45tsB95cJYKCSATwh1M4n8cUnUv6lT&index=6
...
def get_env_feedback(S, A):
    ''' how agent will interact with the environment'''
    if A == 'right':
        if S == N_STATES - 2:
            S_ = 'terminal'
            R = 1
...
def rl():
    ...
    for episode in range(MAX_EPISODES):
        ...
        while not is_terminated:
            ...
            q_predict = q_table.ix[S, A] # predict value
            if S_ != 'terminal':
