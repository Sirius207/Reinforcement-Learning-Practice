...
class DoubleDQN:
    def __init__(
            ...
            reward_decay=0.9,
            e_greedy=0.9,
            replace_target_iter=300,    # change target each 300 steps
            memory_size=500,            # mem 500 data
            batch_size=32,              # for nn
        ...
        # total learning step
        self.learn_step_counter = 0     #for count how much step we run
